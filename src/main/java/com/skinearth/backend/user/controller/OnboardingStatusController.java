...
import com.skinearth.backend.user.service.OnboardingStatusService;
...
@RestController
@RequestMapping("/api/users/me/onboarding-status")
...
public class OnboardingStatusController {
    ...
    @GetMapping
    public ApiResponse<OnboardingStatusResponse> get(@AuthenticationPrincipal Jwt jwt) {
        return ApiResponse.success(
                200,
                "온보딩 상태를 조회했습니다.",
                onboardingStatusService.get(userId(jwt))
        );
    }
